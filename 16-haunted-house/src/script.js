...
door.geometry.setAttribute('uv2', new THREE.Float16BufferAttribute(door.geometry.attributes.uv.array, 2))
...
for (let i = 0; i<50; i++){
    // Random value on a full circle
    const angle = Math.random() * Math.PI * 2;
    // random radius from 4 to 9
...
const tick = () => {
    ...
    ghost1.position.z = Math.sin(ghost1Angle / 2) * 4;
